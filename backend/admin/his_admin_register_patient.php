...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
            ...
            $pat_bill = $_POST['pat_bill'];  // Capture the patient's bill

            // SQL to insert captured values
			$query="insert into his_patients (pat_fname, pat_ailment, pat_lname, pat_age, pat_dob, pat_number, pat_phone, pat_type, pat_addr, pat_bill) values(?,?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssssss', $pat_fname, $pat_ailment, $pat_lname, $pat_age, $pat_dob, $pat_number, $pat_phone, $pat_type, $pat_addr, $pat_bill);
			$stmt->execute();
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputBill" class="col-form-label">Patient Bill</label>
                                                    <input type="number" required="required" name="pat_bill" class="form-control" id="inputBill" placeholder="Patient's Bill Amount">
                                                </div>
                                            </div>
